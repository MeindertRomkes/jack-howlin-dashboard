...
const ICONS: Record<Platform, (props: { className?: string }) => JSX.Element> = {
...
export const PLATFORM_COLORS: Record<Platform, { text: string; bg: string; border: string }> = {
...
export const PLATFORM_BADGE: Record<Platform, { label: string; bg: string; text: string; border: string }> = {
