...
export default function GenerationStatus({ jobId, onComplete, onError }: Props) {
  useEffect(() => {
    ...
    return onSnapshot(ref, snap => {
      ...
      if (data.state === 'success') {
        ...
        onError?.(data.failMsg || 'Generatie mislukt. Probeer het opnieuw.')
      }
    }, () => {
      onError?.('Verbindingsfout tijdens het volgen van de generatiestatus.')
    })
